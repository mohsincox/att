        ...
        <div class="col-md-8 col-sm-offset-2">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">HR Remarks</h3> 
                </div>
                <div class="box-body">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-center"><i class="fa fa-edit"></i> Edit Form of <code><b>HR Remarks</b></code> </h3>
                            </div>
                            <div class="card-body">

                                {!! Form::model($attendance, ['url' => "attendance/$attendance->id", 'method' => 'put', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="form-group {{ $errors->has('hr_remarks') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-xs-9 col-sm-9">
                                        {!! Form::text('hr_remarks', null, ['class' => 'form-control', 'placeholder' => 'HR Remarks', 'autocomplete' => 'off']) !!}
                                        <span class="text-danger">
                                ...
                                <div class="modal modal-primary fade" id="remarks">
