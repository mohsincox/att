        	...
        	<div class="col-md-12 col-sm-offset-0">
            	<div class="box box-success">
                	<div class="box-header with-border">
                    	<h3 class="box-title">HR Leave Update </h3> 
                	</div>
                	<div class="box-body">
                		...
                		<div class="col-sm-12">
    						...
    						<div class="card">
    							...
    							<div class="card-body">
                                    ...
                                    {!! Form::model($leave, ['url' => "hr-leave/$leave->id", 'method' => 'put', 'class' => 'form-horizontal']) !!}
                                    
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12">
                                            <div class="form-group {{ $errors->has('hr_status') ? 'has-error' : ''}}">
                                                {!! Form::label('hr_status', 'HR Status', ['class' => 'required col-xs-3 col-sm-3 control-label']) !!}
                                                <div class="col-xs-9 col-sm-9">
                                                    {!! Form::select('hr_status', ['Approved' => 'Approved', 'Not Approved' => 'Not Approved'], null, ['class' => 'form-control','placeholder' => 'Select HR Status']) !!}
                                                    <span class="text-danger">
                                                        {{ $errors->first('hr_status') }}
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <a href="{{ url('/hr-leave') }}" class="btn btn-default">Cancel</a>
                                       
                                         {!! Form::button('Submit', ['class' => 'btn btn-success pull-right', 'data-toggle' => 'modal', 'data-target' => '#leave_update']) !!}
                                    </div>

                                    <div class="modal modal-success fade" id="leave_update">
