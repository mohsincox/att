    	...
    	<div class="col-md-8 col-sm-offset-2">
        	<div class="box box-success">
            	<div class="box-header with-border">
                	<h3 class="box-title">Process Wise Report</h3> 
            	</div>
            	<div class="box-body">
            		...
            		<div class="col-sm-12">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="text-center"><i class="fa fa-pencil"></i> <code><b>Process</b></code> Wise Report </h3>
							</div>
							<div class="card-body">
						  		
								
                                {!! Form::open(['url' => 'report/process-wise-show', 'method' => 'get', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="form-group {{ $errors->has('process_id') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-xs-9 col-sm-9">
                                       {!! Form::select('process_id', $processList, null, ['class' => 'form-control select2', 'placeholder' => 'Select Process', 'required' => 'required']) !!}
                                        <span class="text-danger">
