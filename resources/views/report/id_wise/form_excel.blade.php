    	...
    	<div class="col-md-8 col-sm-offset-2">
        	<div class="box box-success">
            	<div class="box-header with-border">
                	<h3 class="box-title">ID Wise Report In Excel</h3> 
            	</div>
            	<div class="box-body">
            		...
            		<div class="col-sm-12">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="text-center"><i class="fa fa-pencil"></i> <code><b>ID</b></code> Wise Report In Excel </h3>
							</div>
							<div class="card-body">
						  		
								
                                {!! Form::open(['url' => 'report/id-wise-show-excel', 'method' => 'post', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="form-group {{ $errors->has('attendance_id') ? 'has-error' : ''}}">
                                    {!! Form::label('attendance_id', 'Attendance ID', ['class' => 'col-3 col-sm-3 control-label required']) !!}
                                    <div class="col-xs-9 col-sm-9">
                                       {!! Form::select('attendance_id', $attenIdList, null, ['class' => 'form-control select2', 'placeholder' => 'Select ID', 'required' => 'required']) !!}
                                        <span class="text-danger">
