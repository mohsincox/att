            		...
            		<div class="col-sm-12">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="text-center"><i class="fa fa-pencil"></i> <code><b>Department</b></code> Wise Report </h3>
							</div>
							<div class="card-body">
						  		
								
                                {!! Form::open(['url' => 'report/dept-wise-show', 'method' => 'get', 'class' => 'form-horizontal']) !!}
